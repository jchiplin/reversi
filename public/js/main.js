...
socket.on('game_update',function(payload){
  ...
  if(socket.id == payload.game.player_ice.socket){
    ...
    /*send clients back to the lobby */
    window.location.href = 'lobby.html?username='+username;
  }
    ...
    for(column = 0; column < 8; column++){
      ...
      if(old_board[row][column] != board [row][column]){
        if(old_board[row][column] == '?' && board[row][column] == ' '){
          ...
          $('#'+row+'_'+column).html('<img src="assets/images/empty_to_ice.gif" alt="ice token"/>');
        }
        else if(old_board[row][column] == '?' && board[row][column] == 'b'){
          $('#'+row+'_'+column).html('<img src="assets/images/empty_to_fire.gif" alt="fire token"/>');
        }
        else if(old_board[row][column] == ' ' && board[row][column] == 'w'){
          $('#'+row+'_'+column).html('<img src="assets/images/empty_to_ice.gif" alt="ice token"/>');
        }
          ...
          $('#'+row+'_'+column).html('<img src="assets/images/ice_fade.gif" alt="empty square"/>');
        }
        else if(old_board[row][column] == 'b' && board[row][column] == ' '){
          $('#'+row+'_'+column).html('<img src="assets/images/fire_fade.gif" alt="empty square"/>');
        }
        else if(old_board[row][column] == 'w' && board[row][column] == 'b'){
          $('#'+row+'_'+column).html('<img src="assets/images/ice_to_fire.gif" alt="fire token"/>');
        }
        else if(old_board[row][column] == 'b' && board[row][column] == 'w'){
          $('#'+row+'_'+column).html('<img src="assets/images/fire_to_ice.gif" alt="ice token"/>');
        }
        else{
...
/*by active he has double quote to direct right*/
